...
const serviceProviderController = {
  ...
  login: loginServiceProvider,
  logout: logoutServiceProvider,
  verify: verifyServiceProvider,
  resendVerificationOTP: resendServiceProviderVerificationOTP,
  update: updateServiceProvider,
  remove: deleteServiceProvider,
  resetPassword: resetServiceProviderPassword,
  forgotPassword: forgotServiceProviderPassword,
  profile: getServiceProviderProfile,
  getById: getServiceProvider,
  updateStatus: updateServiceProviderStatus,
  changeProviderPassword,
  getNearbyProviders,
  updateLocation: updateServiceProviderLocation,
