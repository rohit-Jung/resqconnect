...
const organizationController = {
  ...
  verifyOTP: verifyOrgOTP,
  resendVerificationOTP: resendOrganizationVerificationOTP,
  profile: getOrgProfile,
  getAll: getAllOrganizations,
  getById: getOrganizationById,
  remove: deleteOrganization,
  update: updateOrganization,
  updateProfile: updateOrgProfile,
  login: loginOrganization,
  listPublic: listOrganizationsPublic,
  getProviders: getOrgServiceProviders,
  getProviderById: getOrgServiceProviderById,
  registerProvider: registerOrgServiceProvider,
