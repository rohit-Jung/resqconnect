...
• Comply with all applicable laws`,
    },
    {
      ...
      content: `${APP_NAME} is designed to supplement, not replace, traditional emergency services (e.g., calling 112). Response times depend on service provider availability and are not guaranteed.`,
    },
    {
      number: '05',
