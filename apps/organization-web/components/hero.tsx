        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              >
                <Play className="mr-2 h-5 w-5 fill-current" /> Download for
                Android
              </Button>
            </div>
