  ...
  return (
    <section id="how-it-works" className="bg-secondary py-20 md:py-32">
      <div className="container mx-auto px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32">
        <div
          className="mx-auto mb-20 max-w-3xl space-y-4 text-center transition-all duration-700"
          style={{
            opacity: inView ? 1 : 0,
        ...
        >
          ...
          <div className="grid gap-12 md:grid-cols-4">
            {steps.map((step, idx) => (
              <div
                key={idx}
                className="relative flex flex-col items-center gap-4 text-center transition-all duration-600"
                style={{
