...
export const serviceTypeEnum = z.enum(['ambulance', 'police', 'fire_truck', 'rescue_team']);
...
export type TServiceProviderRegisterForm = z.infer<typeof serviceProviderRegisterFormSchema>;
