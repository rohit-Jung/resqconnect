...
import { ServiceCategory, TOrgRegisterForm, orgRegisterFormSchema } from '@/validations/org.schema';
      ...
      <div className="hidden flex-col justify-between bg-gradient-to-br from-[#E63946] to-[#9B2C35] p-12 text-white lg:flex lg:w-1/2">
        <div className="flex flex-1 flex-col items-center justify-center text-center">
          ...
          <p className="mb-12 max-w-md text-lg leading-relaxed opacity-90">
            Register your emergency service organization and become part of our life-saving network.
            Coordinate faster, respond smarter.
          </p>
      ...
      <div className="bg-muted/30 flex min-h-screen w-full items-center justify-center overflow-y-auto p-4 sm:p-6 lg:w-1/2">
        <div className="bg-card my-4 w-full max-w-md rounded-2xl p-6 shadow-xl">
          <div className="mb-4 text-center">
            ...
            <p className="text-muted-foreground text-sm">Join the emergency response network</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
            ...
            <div className="flex items-start gap-2">
              <Checkbox
                ...
                className="mt-0.5"
              />
              <Label htmlFor="terms" className="cursor-pointer text-xs font-normal">
                I agree to the{' '}
                ...
                &{' '}
                <Link href="/organization-agreement" className="text-[#E63946] hover:underline">
