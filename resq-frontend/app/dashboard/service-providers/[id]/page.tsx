            ...
            <div className="bg-card rounded-xl border p-6">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <p className="font-medium">{provider.vehicleInformation.type || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-sm">Number</p>
                  <p className="font-medium">{provider.vehicleInformation.number || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-sm">Model</p>
                  <p className="font-medium">{provider.vehicleInformation.model || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-sm">Color</p>
                  <p className="font-medium">{provider.vehicleInformation.color || 'N/A'}</p>
                </div>
              </div>
            </div>
          )}
              ...
              {provider.isVerified ? (
                <>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Account is verified</p>
                  </div>
                </>
              ) : (
                <>
