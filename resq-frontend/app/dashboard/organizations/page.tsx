...
export default function OrganizationsPage() {
  const organizations = [
    { name: 'City Fire Department', city: 'Downtown', apps: 3, teams: 12, status: 'Active' },
    { name: 'Metro Medical Services', city: 'Central', apps: 2, teams: 8, status: 'Active' },
    { name: 'Police Operations', city: 'Northside', apps: 4, teams: 15, status: 'Active' },
  ];
