...
import { ArrowLeft, CheckCircle, KeyRound, Loader2, ShieldCheck } from 'lucide-react';
      ...
      <div className="hidden flex-col justify-between bg-gradient-to-br from-[#C53030] to-[#7A1F1F] p-12 text-white lg:flex lg:w-1/2">
        <div className="flex flex-1 flex-col items-center justify-center text-center">
          ...
          <p className="mb-16 max-w-md text-lg leading-relaxed opacity-90">
            We&apos;ve sent a verification code to your email. Enter the code to complete your
            account setup and start using ResqConnect.
          </p>
