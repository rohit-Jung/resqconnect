...
import { ISuperAdminLoginResponse, ISuperAdminProfileResponse } from '@/types/auth.types';
...
export const useSuperAdminProfile = (enabled: boolean = true) => {
  return useQuery<AxiosResponse<ApiResponse<ISuperAdminProfileResponse>>, AxiosError>({
