...
const useOrgRegister = () => {
  return useMutation<AxiosResponse<ApiResponse<IOrgRegisterResponse>>, AxiosError, TOrgRegister>({
...
const useOrgVerify = () => {
  return useMutation<AxiosResponse<ApiResponse<IOrgVerifyResponse>>, AxiosError, TOrgVerify>({
