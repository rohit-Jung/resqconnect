import { Facebook, Instagram, Linkedin, ShieldCheck, Twitter } from 'lucide-react';
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div className="space-y-6">
            ...
            <p className="max-w-xs text-sm leading-relaxed">
              Your trusted emergency response companion. Always ready, always reliable, always there
