import { BellOff, ClipboardList, MapPin, Users, Video, Zap } from 'lucide-react';
...
export function Features() {
  const features = [
    ...
    },
    {
      ...
      description: 'Discreetly send alerts without sound or notification in dangerous situations.',
      icon: BellOff,
    },
  ];
      ...
      <div className="container mx-auto px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32">
        <div className="mx-auto mb-16 max-w-3xl space-y-4 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Comprehensive emergency response features designed to keep you and your loved ones safe
          </p>
        </div>
