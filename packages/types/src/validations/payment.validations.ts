...
export type InitiateSubscriptionInput = zType.infer<
  typeof initiateSubscriptionSchema
>;
export type KhaltiCallbackInput = zType.infer<typeof khaltiCallbackSchema>;
export type PaymentStatusInput = zType.infer<typeof paymentStatusSchema>;
export type PaymentHistoryQueryInput = zType.infer<
  typeof paymentHistoryQuerySchema
>;
export type CreateSubscriptionPlanInput = zType.infer<
  typeof createSubscriptionPlanSchema
>;
export type UpdateSubscriptionPlanInput = zType.infer<
